...
const AboutMAIT = () => {
  ...
  const highlights = [
    ...
    },
    {
      ...
      description:
        "Experienced professors and industry veterans guiding innovation.",
      aos: "fade-up",
    },
    {
      icon: FaLightbulb,
      ...
      description:
        "Cutting-edge labs fostering creativity and breakthrough research.",
      aos: "zoom-in-up",
    },
    {
      icon: FaAward,
  ...
  return (
    <div className="p-0 bg-white rounded-xl">
      <div className="bg-gray-950 text-white min-h-screen py-16 px-4 md:px-8 lg:px-16">
        <div
          className="text-center mb-16 md:mb-20 animate-fade-in-down"
          data-aos="fade-down"
        >
          <h1 className="text-4xl sm:text-5xl font-extrabold mb-4">
            About <span className="text-[#FF9900]">MAIT</span>
          </h1>
          <p className="text-gray-300 max-w-3xl mx-auto text-base sm:text-xl font-light">
            Maharaja Agrasen Institute of Technology — shaping future engineers
            through excellence in education, cutting-edge research, and
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-20 md:mb-24 transition-all duration-200 ease-in-out">
          {stats.map((s, idx) => (
            ...
            >
              <div
                className={`text-3xl sm:text-4xl font-extrabold mb-1 ${s.color}`}
              >
                {s.value}
              </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10 md:gap-12 my-16 md:my-20">
          <div
            className="w-full lg:w-1/2 relative group overflow-hidden rounded-3xl shadow-2xl"
            data-aos="fade-right"
          >
            <img
              src="/mait.jpg"
          ...
          <div
            className="w-full lg:w-1/2 space-y-4 md:space-y-6 animate-fade-in-up"
            data-aos="fade-left"
          >
            ...
            <p className="text-gray-300 text-base md:text-lg" aos="fade-up">
              Maharaja Agrasen Institute of Technology (MAIT) offers a vibrant
              campus life, cutting-edge infrastructure, and world-class
              education in the heart of Delhi. Our campus is equipped with
              high-tech labs, research centers, and collaborative learning
              spaces.
            </p>
        ...
        <div className="mb-20 md:mb-24">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-8 md:mb-10">
            Why Choose <span className="text-[#FF9900]">MAIT?</span>
          </h2>
              ...
              return (
                ...
                >
                  <div className="mb-4 flex justify-center">
                    <IconTag
                      className={`text-3xl transition-transform duration-300 group-hover:scale-125 ${h.iconColor}`}
                    />
                  </div>
        ...
        >
          <h2 className="text-2xl sm:text-3xl font-bold mb-3 md:mb-4 text-white">
            Ready to Build the <span className="text-[#FF9900]">Future?</span>
          </h2>
          <p className="text-gray-200 mb-6 max-w-2xl mx-auto text-sm md:text-base">
            ...
            MAIT. Experience a world-class campus, vibrant research, and career
            opportunities.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4">
            ...
            >
              <button className="w-full border border-white hover:bg-white hover:text-black px-5 py-2 md:px-6 md:py-3 rounded-xl font-bold transition-all duration-300 hover:scale-105 hover:shadow-xl flex items-center justify-center gap-2">
                <FaGlobe />
                <span>Visit MAIT Website</span>
              </button>
            </a>
          </div>
        </div>
